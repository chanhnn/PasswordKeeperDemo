...
{
    public class PasswordTemplatePageViewModel : BaseViewModel
    {
        ...
        public PasswordTemplatePageViewModel(INavigationService navigationService) : base(navigationService)
        {
            try
            {
                Title = "Password";
